...
const GlassesAnimation = () => {
  ...
  return (
    <div className="glasses-wrapper">
      <img ref={triggerRef1} className="glasses g1" src="images/glasses.png" alt="Glasses"/>
      <img ref={triggerRef2} className="glasses g2" src="images/glasses.png" alt="Glasses"/>
      <img ref={triggerRef3} className="glasses g3" src="images/glasses.png" alt="Glasses"/>
