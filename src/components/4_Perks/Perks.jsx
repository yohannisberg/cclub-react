          ...
          <div className="grid-wrapper">
            <div className="table">
              <div className="table-row">
                ...
                <p className="table-head"><img className="lazyload" src="images/cupcake.png" alt="Cupcake" /><br />FRIEND <br /><span>free to join</span></p>
                <p className="table-head"><img className="lazyload" src="images/cake.png" alt="Cake"/><br/>BESTIE <br/><span>spend $100/yr</span></p>
              </div>
              ...
              <div className="table-row">
                ...
                <p className="table-cell"><img className="check" src="images/check.png" alt="Check"/></p>
              </div>	
